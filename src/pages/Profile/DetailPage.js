        ...
        <div>
          ...
          >
            ...
            <Row style={{ paddingLeft: 30 }}>
              ...
              relevanceInfo[i].dossier_current_custody_details.cabinet_id ? (
                relevanceInfo[i].dossier_current_custody_details.cabinet_id == '106202002' ? (
                  <Col md={6} span={24}>
                    存储位置：
                    {`${relevanceInfo[i].dossier_current_custody_details.kfmc}/${
                      relevanceInfo[i].dossier_current_custody_details.qymc
                    }/${relevanceInfo[i].dossier_current_custody_details.kwmc}/${
                      relevanceInfo[i].dossier_current_custody_details.gmc
                    }/${relevanceInfo[i].dossier_current_custody_details.mjjmc}/${
                      relevanceInfo[i].dossier_current_custody_details.mmc
                    }`}
                  </Col>
                ) : (
                  <Col md={6} span={24}>
