export default {
  ...
  // 'menu.form.archivesstatisticsform.archivesstatisticsindex4': '档案统计4',
  ...
  'menu.profile': '卷宗',
  'menu.profile.basic': '数据统计',
  'menu.profile.advanced': '数据查询',
  'menu.result': '涉案财物',
  'menu.result.success': '违规监督',
  'menu.result.fail': '数据统计',
  'menu.exception': '异常',
  ...
  'app.forms.basic.title': '音视频管理',
  'app.forms.information.title': '综合信息查询',
  'app.forms.dynamic.title': '违规动态展示',
  'app.forms.case.title': '案件统计',
  // 'app.forms.archives.title': '档案统计',
