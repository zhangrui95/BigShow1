  ...
  render() {
    return (
      <Card bodyStyle={{ height: 565, padding: 0 }}>
        <div className={styles.blockTitle} style={{ position: 'absolute', top: 10, left: 20 }}>
          {this.state.mapAreaName}
        </div>
        <div className={styles.setMapDefaultBtn}>
          <a onClick={() => this.setMapDefault()}>返回全局</a>
        </div>
        <div id="RegulateMap" style={{ height: '100%', width: '100%', maxWidth: 515 }} />
      </Card>
    );
  }
}
